...
*Os principais mecanismos de pesquisa usados ​​pelos usuários.*
...
* [DuckDuckGo](https://duckduckgo.com) - um mecanismo de pesquisa na Internet que enfatiza a proteção da privacidade dos usuários.
* [Factbites](http://www.factbites.com)
* [Gigablast](http://gigablast.com)
* [Goodsearch](http://www.goodsearch.com)
* [Google Search](http://www.google.com) - Motor de busca mais popular.
...
* [Gerador de Certidões](https://www.4devs.com.br/gerador_numero_certidoes)
* [Gerador de CNH](https://www.4devs.com.br/gerador_de_cnh)
* [Gerador de Conta Bancária](https://www.4devs.com.br/gerador_conta_bancaria)
* [Gerador de CPF](https://www.4devs.com.br/gerador_de_cpf)
* [Gerador de Currículo](https://www.4devs.com.br/gerador-de-curriculo)
* [Gerador de Nicks](https://www.4devs.com.br/gerador_de_nicks)
* [Gerador de Nomes](https://www.4devs.com.br/gerador_de_nomes)
* [Gerador de Números Aleatórios](https://www.4devs.com.br/gerador_de_numeros_aleatorios)
* [Gerador de PIS/PASEP](https://www.4devs.com.br/gerador_de_pis_pasep)
* [Gerador de RENAVAM](https://www.4devs.com.br/gerador_de_renavam)
* [Gerador de Veículos](https://www.4devs.com.br/gerador_de_veiculos)
* [Gerador Placa de Veículos](https://www.4devs.com.br/gerador_de_placa_automoveis)
...
* [Gerador Inscrição Estadual](https://www.4devs.com.br/gerador_de_inscricao_estadual)
* [Gerador Título de Eleitor](https://www.4devs.com.br/gerador_de_titulo_de_eleitor)
* [Gerador Cartão de Crédito](https://www.4devs.com.br/gerador_de_numero_cartao_credito)
* [Gerador de Pessoas](https://www.4devs.com.br/gerador_de_pessoas)
* [Gerador de Empresas](https://www.4devs.com.br/gerador_de_empresas)
* [Gerador de Imagem](https://www.4devs.com.br/gerador_de_imagem_lorem_pixel)
* [Gerador de Lorem Ipsum](https://www.4devs.com.br/gerador_de_texto_lorem_ipsum)
* [Gerador de Senha](https://www.4devs.com.br/gerador_de_senha)
...
*Mecanismos de pesquisa localizados por país.*

* [Alleba (Philippines)](http://www.alleba.com) - Motor de busca das Filipinas
* [Baidu (China)](http://www.baidu.com) - O principal mecanismo de pesquisa usado na China
...
*Motores de busca menos conhecidos e usados.*
...
APIs para fazer OSINT WHO4REYOU compartilhando conhecimento

* [APIs](https://pastebin.com/UxbeZ2Du)
...
*Mecanismos de busca para informações ou tópicos específicos.*
...
*Mecanismos de busca que rastreiam vários sites (Google, Yahoo, Bing, Goo etc.) ao mesmo tempo e retornam resultados.*

* [Carrot2](http://search.carrot2.org) - Organiza seus resultados de pesquisa em tópicos.
* [Yippy](http://yippy.com) - Pesquise usando várias fontes de uma só vez
...
*Encontre sites semelhantes. Bom para pesquisa de concorrência comercial*

* [Google Similar Pages](https://chrome.google.com/webstore/detail/google-similar-pages/pjnfggphgdjblhfjaphkjhfpiiekbbej)
* [SimilarSites](http://www.similarsites.com) - Descubra sites semelhantes entre si
* [SitesLike](http://www.siteslike.com) - Encontre sites semelhantes por categoria
...
*Pesquise dados localizados em PDFs, documentos do Word, slides de apresentação e muito mais.*
...
*Encontre informações que foram enviadas para Pastebin.*

* [PasteLert](http://andrewmohawk.com/pasteLert) - PasteLert é um sistema simples para pesquisar em pastebin.com e configurar alertas (como alertas do google) para entradas em pastebin.com.

## [↑](#contents) Code Search

*Pesquisar por código fonte do site*

* [NerdyData](https://search.nerdydata.com) - Mecanismo de pesquisa para código fonte.
* [SearchCode](https://searchcode.com) - Ajude a encontrar exemplos reais de funções, APIs e bibliotecas em mais de 10 fontes.
...
* [Icerocket](http://www.icerocket.com)
* [Notey](http://www.notey.com) - Mecanismo de pesquisa de postagem no blog.
...
* [Knowem](http://www.Knowem.com) - Procure um nome de usuário em mais de 500 redes sociais populares.  
...
* [facesearch](http://facesaerch.com) - Pesquise imagens de uma pessoa pelo nome.
* [Family Search](https://familysearch.org)
* [Family Tree Now](http://www.familytreenow.com/)
* [Federal Bureau of Prisons - Inmate Locator (US)](http://www.bop.gov/inmateloc) - Encontre um preso que esteja no sistema do Federal Bureau of Prisons.
* [Fold3 (US Military Records)](http://www.fold3.com) - Procure registros de membros das Forças Armadas dos EUA
...
* [Pipl](https://pipl.com)
* [Probusca](https://probusca.com/index.php)
...
* [h8mail](https://github.com/khast3x/h8mail) - Busca por violação de senha e e-mail OSINT, localmente ou usando serviços premium. Suporta a busca de emails relacionados
* [Have I Been Pwned](https://haveibeenpwned.com) - Pesquise várias violações de dados para verificar se o seu endereço de email foi comprometido.
* [Hunter](https://hunter.io) - O Hunter permite encontrar endereços de e-mail em segundos e se conectar com as pessoas que são importantes para o seu negócio.
...
* [VoilaNorbert](https://www.voilanorbert.com) - Encontre as informações de contato de qualquer pessoa para pesquisa de leads ou aquisição de talentos.
* [We Leak Info](https://weleakinfo.com/) - Weleakinfo é o principal mecanismo de busca de dados de violação do setor. Banco de dados contendo mais de 10 bilhões de registros e 7.000 violações de dados.

## [↑](#contents) Phone Number Research
* [National Cellular Directory](https://www.nationalcellulardirectory.com/) - foi criado para ajudar as pessoas a pesquisar e se reconectar, realizando pesquisas de telefone celular. Os produtos de pesquisa incluem bilhões de registros que podem ser acessados ​​a qualquer momento, além de pesquisas gratuitas uma hora por dia, todos os dias.
* [Reverse Phone Lookup](http://www.reversephonelookup.com/) - Informações detalhadas sobre operadora de telefonia, região, provedor de serviços e informações sobre comutadores.
* [Spy Dialer](http://spydialer.com/) - Obter o correio de voz de uma pesquisa de telefone celular e nome do proprietário.
* [Twilio](https://www.twilio.com/lookup) - Procure um tipo de operadora de números de telefone, local etc.
* [Phone Validator](https://www.phonevalidator.com/index.aspx) - Serviço de pesquisa de telefone bastante preciso, particularmente bom em relação aos números do Google Voice.
...
* [ahrefs](https://ahrefs.com) - Uma ferramenta para pesquisa de backlink, pesquisa orgânica de tráfego, pesquisa de palavras-chave, marketing de conteúdo e muito mais.
...
* [Domain Tools](http://whois.domaintools.com) - Pesquisa Whois e dados históricos de domínio / ip.
* [Easy whois](https://www.easywhois.com)
* [Exonera Tor](https://exonerator.torproject.org) - Um banco de dados de endereços IP que fizeram parte da rede Tor. Ele responde à pergunta se havia um relé Tor rodando em um determinado endereço IP em uma determinada data.
...
* [MXToolbox](http://origin.mxtoolbox.com) - MX ferramenta de pesquisa de registro.
...
* [SecurityTrails](https://securitytrails.com/dns-trails) - API para pesquisar registros DNS atuais e históricos, WHOIS atual e histórico, tecnologias usadas por sites e whois procurar telefone, email, endereço, IPs etc.
* [SEMrush](https://www.semrush.com)
* [SEO Chat Tools](http://tools.seochat.com)
* [SEOTools for Excel](http://seotoolsforexcel.com)
* [Similar Web](https://www.similarweb.com) - Compare todas as estatísticas e análises de tráfego do site.
* [SmallSEOTools](http://smallseotools.com)
* [StatsCrop](http://www.statscrop.com)
* [Squatm3gator](https://github.com/david3107/squatm3gator) - Enumerar domínios disponíveis gerados modificando o nome de domínio original por meio de diferentes técnicas de cybersquatting
* [TCPIPUTILS.com](http://www.tcpiputils.com)
* [urlQuery](http://urlquery.net)
* [URLVoid](http://www.urlvoid.com) - Analisa um site por meio de vários mecanismos de lista negra e ferramentas de reputação online para facilitar a detecção de sites fraudulentos e mal-intencionados.
...
* [Google Adwords](http://adwords.google.com) - Obtenha dados e estatísticas mensais de volume de palavras-chave.
* [Google Trends](https://www.google.com/trends) - Veja quantos usuários estão pesquisando por palavras-chave específicas.
...
* [Wayback Machine](http://archive.org/web/web.php) - Explore a história de um site.
...
* [Google Input Tools](https://www.google.com/inputtools/try) - Facilita a digitação do idioma escolhido em qualquer lugar da Web.
...
* [Unsplash](https://unsplash.com) - Fotos gratuitas de alta resolução.
...
* [Frame by Frame](https://chrome.google.com/webstore/detail/frame-by-frame-for-youtub/elkadbdicdciddfkdpmaolomehalghio?hl=en-GB) - Plug-in do navegador que permite assistir a vídeos do YouTube quadro a quadro.
...
* [ccSUBS](http://ccsubs.com/) - Baixar legendas e legendas ocultas do YouTube
...
* [The Collection of Computer Science Bibliographies](https://liinwww.ira.uka.de/bibliography/index.html) - O CCSB é uma coleção de bibliografias da literatura científica em ciência da computação de várias fontes, cobrindo a maioria dos aspectos da ciência da computação.
...
* [JSTOR](http://www.jstor.org) - Pesquise mais de 10 milhões de artigos de periódicos acadêmicos, livros e fontes primárias.
...
indexa todos os relatórios de projetos públicos alemães e muitos artigos científicos.
...
* [PubMed](http://www.ncbi.nlm.nih.gov/pubmed) - Pesquise mais de 27 milhões de citações de literatura biomédica no MEDLINE, periódicos de ciências da vida e livros on-line.
...
* [Snopes](http://www.snopes.com) - A fonte definitiva de referência na Internet para lendas urbanas, folclore, mitos, rumores e informações erradas.
...
* [Google Alerts](http://www.google.com/alerts) - Um serviço de detecção e notificação de alterações de conteúdo.
...
* [Tor Browser](https://www.torproject.org/projects/torbrowser.html.en) - O Tor é um software gratuito que impede que as pessoas aprendam sua localização ou hábitos de navegação, permitindo que você se comunique mamente na Internet.
...
* [A1 Website Download](http://www.microsystools.com/products/website-download) - Baixe sites inteiros em disco.
...
* [HTTrack](http://www.httrack.com) - Permite baixar um site da Internet para um diretório local, criando recursivamente todos os diretórios, obtendo HTML, imagens e outros arquivos do servidor para o seu computador.
...
* [Convert Words to Time](https://wordstotime.com) - Converte o número de palavras em uma apresentação ou discurso em quantos minutos serão necessários para ler.
...
* [Unroll.me](https://unroll.me) - Cancele a inscrição com facilidade em um clique das assinaturas de email.
...
* [ABBYY FineReader Corporate 14](https://tinyurl.com/yypx7abv) : Senha roonney
...
* [Navigator Platform](https://www.liferaftinc.com/)
...
* [Cardsmith](http://cardsmith.co) - Crie sistemas de colaboração visual com a familiaridade de notas adesivas em um quadro branco.
* [CloudApp](http://www.getcloudapp.com)
...
* [~~Todoyu~~](http://www.todoyu.com) - Projeto original descontinuado - agora mantido em [Todoyu-PHP7.x](https://github.com/AlexEdimensionz/Todoyu-PHP7.x)
